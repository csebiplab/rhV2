...
const faqQuestionsNAns = [
  ...
  },
  {
    id: 9,
    question:
      "Can I customize the design of my bathroom? ",
    answer:
  ...
  },
  {
    id: 11,
    question:
      "What materials do you recommend for bathroom renovations?",
    answer:
  ...
  },
  {
    id: 14,
    question:
      "Will I need to leave my home during the renovation? ",
    answer:
  ...
  },
  {
    id: 17,
    question:
      "Do you offer eco-friendly options for bathroom renovations? ",
    answer:
  ...
  },
  {
    id: 18,
    question:
      "Can you expand or reconfigure the layout of my bathroom? ",
    answer:
  ...
  },
  {
    id: 20,
    question:
      "Will you remove old fixtures and debris during the renovation?",
    answer:
  ...
  },
  {
    id: 22,
    question:
      "Can you install custom cabinetry or vanities? ",
    answer:
  ...
  },
  {
    id: 23,
    question:
      "How do I get started with my bathroom renovation project?",
    answer:
  ...
  },
  {
    id: 25,
    question:
      "Do you offer design consultations before the renovation? ",
    answer:
  ...
  },
  {
    id: 26,
    question:
      "How do you ensure high-quality workmanship on every project?",
    answer:
  ...
  },
  {
    id: 27,
    question:
      "Will the renovation affect the plumbing in the rest of my home?",
    answer:
  ...
  },
  {
    id: 30,
    question:
      "What are the latest trends in bathroom design that you offer?",
    answer:
  ...
  },
  {
    id: 31,
    question:
      "How will you communicate progress during the renovation?",
    answer:
      ...
      <div className="flex flex-col justify-center items-center">
              ...
              <div>
                <h2 className="text-3xl lg:text-[32px] xl:text-[34px] 2xl:text-4xl 3xl:text-[38px] 4xl:text-[40px] 5xl:text-[42px] leading-normal font-bold text-black text-center pb-2">
                  Bath Construction <span className="text-primary"> Project Questions And Answers </span>
                </h2>
              </div>
            </div>
            <>
