          ...
          <div className="grid md:grid-cols-3 2xl:gap-[40px] md:gap-[30px] ">
            ...
            <div className="border-2 my-6 md:my-0 cart2">
              <div className="title-bg2">
                <Image
                  src="/assets/home_page/new_home_page/why_choose_us.png"
            ...
            <div className="mx-auto flex flex-col items-center justify-center">
              ...
              <div>
                <p className="text-lg font-normal md:text-start text-center">
                  At RH Construction USA Inc., we pride ourselves on delivering
                  top-notch general contracting services in Brooklyn. With years
                  of experience in the industry, we provide a seamless
                  construction experience that prioritizes quality,
                  transparency, and customer satisfaction. Here's why you should
                  choose us: Choosing RH Construction USA Inc. means partnering
                  with a trusted, dedicated team that delivers superior results
                  and ensures your satisfaction from start to finish. Let us
                  bring your construction dreams to life with professional,
                  reliable service!
                </p>
              </div>
            </div>
