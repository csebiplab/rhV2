...
const AboutUs = () => {
  return (
    <div>
      <div className="container pt-[30px] md:pt-0">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-[23px]">
          <div className="order-2 md:order-1 md:col-span-3 ">
            ...
            <div className="flex justify-between md:justify-start items-center gap-[5px] md:gap-[35px] pt-[25px]">
                <Link href="tel:+1 (646) 683-4612"><button className="flex items-center gap-[14px] btn__bg text-base font-bold leading-normal text-black py-[15px] px-[15px] md:px-[30px]">Request A Quote <svg xmlns="http://www.w3.org/2000/svg" width="9" height="14" viewBox="0 0 9 14" fill="none">
