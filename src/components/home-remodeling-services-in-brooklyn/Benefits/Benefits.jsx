      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px]">
        {
          benefitsData?.map((data)=>{
              return <div key={data.id} className="cart__bg relative mt-12 px-[10px] pb-[34px]">
                  <Image src={data.img} alt="benefit image" width={92} height={92} className="absolute -top-12 left-0 right-0  w-[92px] h-[92px] mx-auto p-2 border-[3px] border-black rounded-full bg-white"/>
