import s1 from "../../../../public/assets/kitchen/KitchenRemodelingServices-1.png";
import s2 from "../../../../public/assets/kitchen/KitchenRemodelingServices-2.png";
import s3 from "../../../../public/assets/kitchen/KitchenRemodelingServices-3.png";
import s4 from "../../../../public/assets/kitchen/KitchenRemodelingServices-4.png";
import s5 from "../../../../public/assets/kitchen/KitchenRemodelingServices-5.png";
import s6 from "../../../../public/assets/kitchen/KitchenRemodelingServices-6.png";
import s7 from "../../../../public/assets/kitchen/KitchenRemodelingServices-7.png";
import s8 from "../../../../public/assets/kitchen/KitchenRemodelingServices-8.png";
import s9 from "../../../../public/assets/kitchen/KitchenRemodelingServices-9.png";
import s10 from "../../../../public/assets/kitchen/KitchenRemodelingServices-10.png";
      ...
      <div className="container">
        <div className="common__padding__top">
          <div className="flex flex-col justify-center items-center">
            <HeadingIcon
              text={headingIconText.kitchenRemodelingServices__IconTxt}
            />
            ...
            <p className="font-normal lg:text-base md:text-sm text-center">
              As a reputable company, RH Construction USA Inc. prioritizes
              customer satisfaction, focusing on transparent communication and
              attention to detail throughout the entire process of kitchen
              remodeling in Brooklyn. Our commitment to excellence is evident in
              the use of premium materials, meticulous planning, and adherence
              to timelines. Various kitchen renovation services are offered by
              our company:
            </p>
          </div>
          ...
          <div className="mt-4">
            ...
            >
              {slideContents.map((slide, index) => (
                <SwiperSlide
                  key={index}
                  className={`text-center pt-4 !h-auto !md:h-full`}
                >
