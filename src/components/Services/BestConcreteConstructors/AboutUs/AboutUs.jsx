...
const AboutUs = () => {
    return (
        <div className="full__section_r_p pl-3 md:pl-0 mt-[55px] md:mt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[22px]">
                ...
                <div className="md:col-span-1">
                    ...
                    <h2 className='text-[25px] md:text-[26px] lg:text-[28px] xl:text-[30px] 2xl:text-[31px] 3xl:text-[33px] 4xl:text-[34px] 5xl:text-[36px] font-bold leading-normal text-black text-center md:text-left'>About Our Concrete <br className="block md:hidden"/> Constructors in Brooklyn</h2>
