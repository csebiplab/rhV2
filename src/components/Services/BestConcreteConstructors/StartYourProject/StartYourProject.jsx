        ...
        <div className="full__section_l_p pr-3 md:pr-0 common__padding__top">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[22px]">
                ...
                <div className="order-1 md:col-span-1">
                    ...
                    <h2 className='text-[25px] md:text-[26px] lg:text-[28px] xl:text-[30px] 2xl:text-[31px] 3xl:text-[33px] 4xl:text-[34px] 5xl:text-[36px] font-bold leading-normal text-black text-center md:text-left'>Ready to Start Your Project with Our Concrete Constructors</h2>
