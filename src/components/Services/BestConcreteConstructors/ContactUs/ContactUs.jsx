            ...
            <div className="rounded-lg p-5 lg:col-span-3 lg:p-12 items-center">
              ...
              <form action="#" className="space-y-4 ">
                <div>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:mb-5 mb-4">
                    <div>
                      ...
                      <input
                        className="w-full input__bg p-3 text-sm font-normal leading-normal placeholder-black"
                ...
                <div>
                  ...
                  <textarea
                    className="w-full input__bg  p-4 text-sm font-normal leading-normal placeholder-black"
