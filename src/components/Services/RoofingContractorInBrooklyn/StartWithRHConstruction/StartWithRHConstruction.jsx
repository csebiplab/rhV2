        ...
        <div className=" grid md:grid-cols-7 grid-cols-1 md:gap-[30px]">
          ...
          <div className="md:col-span-3 pt-3 lg:pt-0 flex flex-col justify-center items-center md:items-start md:pt-0">
            <div className="flex md:justify-normal justify-center md:items-start items-center">
              <HeadingIcon
                text={headingIconText.startWithRhConstruction__headingIconText}
              />
            </div>
            ...
            <p className="text-lg font-normal md:text-start text-center py-[10px]">
              RH is your premier choice for roofing contractors in Brooklyn, NY,
              offering unparalleled expertise and quality in all roofing
              services. Specializing in both residential and commercial
              projects, we deliver top-notch roofing solutions that ensure
              durability and longevity. Our experienced team is dedicated to
              using{" "}
              <Link
                rel="nofollow"
                target="_blank"
                className="text-primary hover:underline"
                href="https://en.wikipedia.org/wiki/High_grading"
              >
                high-grade materials
              </Link>{" "}
              and advanced techniques to provide reliable installations,
              repairs, and maintenance. We focus on meticulous craftsmanship and
              personalized service to meet your specific needs. Which ensures
              that your roof remains in excellent condition and enhances the
              value of your property. From complete roof replacements to routine
              inspections, RH Construction USA is committed to delivering
              exceptional results and customer satisfaction. Choose us for
              enduring roofing solutions that provide both protection and
              aesthetic appeal for your home or business.
            </p>
