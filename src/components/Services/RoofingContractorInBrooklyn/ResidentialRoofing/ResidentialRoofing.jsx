        ...
        <div className=" grid md:grid-cols-6 grid-cols-1 gap-10">
          <div className="order-2 md:order-1 md:col-span-3">
            <div className="flex md:justify-normal justify-center md:items-start items-center">
              <HeadingIcon
                text={headingIconText.residentialRoofing__headingIconText}
              />
            </div>
            ...
            <p className="text-lg font-normal md:text-start text-center py-[10px]">
              RH Construction USA Inc. is your trusted residential roofing
              contractor in Brooklyn. We specialize in providing top-notch
              roofing solutions tailored to the unique needs of homeowners. Our
              services include expert installation, repair, and maintenance,
              ensuring your roof is both durable and aesthetically pleasing.
              With a commitment to high-quality materials and craftsmanship, we
              ensure your home is protected from the elements. Our experienced
              ...
              minor repairs to complete roof replacements.
            </p>
          </div>
