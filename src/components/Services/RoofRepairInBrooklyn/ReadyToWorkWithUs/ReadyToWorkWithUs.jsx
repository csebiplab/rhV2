        ...
        <div className=" grid md:grid-cols-6 grid-cols-1 md:gap-[30px]">
          ...
          <div className="md:col-span-3 pt-3 lg:pt-0 flex flex-col justify-center items-center md:items-start md:pt-0">
            <div className="flex md:justify-normal justify-center md:items-start items-center">
              <HeadingIcon
                text={headingIconText.readyToWorkWithUs__headingIconText}
              />
            </div>
            ...
            <p className="text-lg font-normal md:text-start text-center py-[10px]">
              Start your project with us and experience top-notch roof repair
              services from a team of skilled professionals dedicated to quality
              and customer satisfaction. We offer expert solutions, clear
              communication, and reliable results to ensure your roofing needs
              are met efficiently and effectively. Reach out today to begin your
              project and protect your home with confidence. From initial
              consultation and detailed inspections to prompt repairs and final
              quality checks, we ensure a seamless and stress-free experience.
              We are committed to delivering exceptional craftsmanship and
              lasting results, tailored to your specific roofing needs. Let us
              handle your project with professionalism and expertise, providing
              you with peace of mind and a roof you can depend on. Contact us
              today to get started and see the difference our dedicated service
              can make.
            </p>
