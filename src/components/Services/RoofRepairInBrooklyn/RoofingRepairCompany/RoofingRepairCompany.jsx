      ...
      <div className="container common__padding__top">
        <div className=" grid md:grid-cols-6 grid-cols-1 md:gap-[30px]">
          <div className="md:col-span-3 flex items-center ">
            <div className="">
              <Image
                src="/assets/roof_repair/RoofingRepairCompany.jpeg"
                width={680}
                height={540}
          ...
          <div className="md:col-span-3 pt-3 lg:pt-0 flex flex-col justify-center items-center md:items-start md:pt-0">
            <div className="flex md:justify-normal justify-center md:items-start items-center">
              <HeadingIcon
                text={headingIconText.roofingRepairCompany__headingIconText}
              />
            </div>
            ...
            <p className="text-lg font-normal md:text-start text-center py-[10px]">
              When it comes to top-quality roof repair, RH Construction USA Inc.
              is the best roofing repair company in Brooklyn, NY. Our reputation
              for excellence is built on a foundation of skilled craftsmanship,
              reliable service, and unmatched professionalism. With years of
              experience in the industry, our team of experts is adept at
              handling all types of roofing issues, from minor leaks and damaged
              shingles to extensive storm damage and structural repairs. We use
              only premium materials and advanced techniques to ensure durable,
